...
public class luckiestAndUnluckiestDay {
    public luckiestAndUnluckiestDay(){
    ...
    public static void winOrLooseAmount(){
    ...
    public static void monthWinOrLooseDayt() {
        ...
        for (int i = 0; i >= monthDays.length; i++) {
            ...
            System.out.println("The comparison between win and loose:"+compare);
            System.out.println("For "+monthName[i]+"total win-money :"+monthWiningAmount);
